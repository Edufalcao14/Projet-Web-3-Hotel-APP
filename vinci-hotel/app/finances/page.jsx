...
export default function Finances() {
  ...
  return (
    <section className="w-full flex flex-col bg-gray-100">
      <div className="h-full pt-3 pb-3 sm:pt-6 sm:pb-6 border-b-2 sm:text-center">
        <h1 className="text-gray-800 text-2xl md:text-3xl mx-5 text-center lg:text-left">
          Tableau de Bord - Finances
        </h1>
      </div>

      <div className="bg-lighBackground-image bg-cover bg-no-repeat mx-4 sm:mx-6 my-3 rounded-2xl p-4 sm:p-8">
        <div className="flex flex-wrap justify-center items-center mx-4 sm:mx-8 my-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-8 mx-4 my-6 rounded-lg shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 mx-4 my-6 rounded-lg shadow-lg"></div>
    </section>
  );
}
