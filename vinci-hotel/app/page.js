...
const navItems = [
  {
    name: "RESERVATIONS",
    url: "/reservations",
    icon: <FaCalendarDays color="#C18E50" size={35} />,
  },
  {
    name: "FINANCES",
    url: "/finances",
    icon: <FaCoins color="#C18E50" size={35}/>,
  },
  {
    name: "CHAMBRES",
    url: "/chambres",
    icon: <FaBed color="#C18E50" size={35} />,
  },
  {
    name: "SERVICES",
    url: "/services",
    icon: <MdFreeBreakfast color="#C18E50" size={35}  />,
  },
];
  ...
  return (
    <section className="bg-background-image bg-no-repeat bg-cover flex flex-row min-h-screen">
      <div className="container flex flex-col justify-center items-center px-24 sm:px-36">
        ...
        la gestion de vos chambres et la satisfaction de vos clients, pour prendre
         les meilleures décisions et optimiser votre établissement
        </p>
