    ...
    return (
        <div className="max-w-md mx-auto font-sans">
            <h3 className="text-lg font-semibold flex items-center space-x-2">
                ...
                <span className="text-2xl ml-3 font-medium text-[#5A5555]">Prévisions pour le mois</span>
            </h3>
            ...
            <div
                className="relative w-full h-6 rounded-md overflow-hidden bg-[#CB584E]">
                <div
            ...
            <div className="flex justify-between mt-4">
                ...
                <div className="justify-center text-center">
                    <p className="text-red-500 font-medium text-lg">❌ Paiement en attente</p>
                    <p className="font-bold text-gray-700 text-lg">
