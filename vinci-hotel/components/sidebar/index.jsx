  ...
  if (!isHome) {
    return (
        <div className="flex">
          ...
          >
            <Link href="/">
              <Image src="/images/logo-small.svg" width={100} height={100}
                     alt="logo"/>
            </Link>

            <nav
                className="justify-center items-center mt-6 text-center font-mono text-xl text-white">
              {navItemsData.map((item, index) => (
                  <NavItem key={item.name + index} name={item.name}
